...
/// <summary>
/// Global exception handling middleware for API Gateway
/// </summary>
public class GlobalExceptionMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        {
            _logger.LogError(ex, "An unhandled exception occurred in API Gateway");
    ...
    private async Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        var (statusCode, body) = exception switch
        {
            ...
            HttpRequestException ex => (
                ...
                Body: new ProblemDetails
                {
                    ...
                    Instance = context.Request.Path,
                    Extensions = { ["errorCode"] = "UPSTREAM_SERVICE_ERROR", ["upstreamError"] = ex.Message }
                }
            ),
        ...
        body.Extensions["service"] = "Gateway.API";
        body.Extensions["version"] = "1.0.0";
