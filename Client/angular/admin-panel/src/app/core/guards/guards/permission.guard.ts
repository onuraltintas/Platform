...
import { AUTHORIZATION_POLICIES } from '../../../features/access-control/feature/auth/authorization.policies';
import { AuthorizationPolicyService } from '../../../features/access-control/data-access/authorization-policy.service';
